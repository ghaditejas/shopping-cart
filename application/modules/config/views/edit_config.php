<div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form id="add_user" class="add_user" action="<?php echo base_url(); ?>config/config/config_update<?php if(isset($edit_id)){echo "/".$edit_id;}?>" method="post">
                        <!-- text input -->
                        <div class="box-body">
    ...
    echo $config_type;
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="conf_val" id="conf_val" placeholder="Configuration Value" type="text" value="<?php if (isset($config_value)) {
    echo $config_value;
} ?>">
