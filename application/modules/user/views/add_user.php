    ...
    echo "/" . $edit_id;
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="firstname" id="fname" placeholder="First Name" type="text" value="<?php
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="lastname" id="lname" placeholder="Last Name" type="text" value="<?php
                            ...
                            <div class="form-group">
                                <label>Email*</label>
                                <input class="form-control" name="email" id="email" placeholder="Email" type="text" value="<?php
                                if (set_value('email') != "") {
